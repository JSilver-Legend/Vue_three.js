...
export function useJsonLocal() {
  const jsonStructure = ref({
    ...
    "appMarkup": [
      {
        "description": "a999112anlageNasslack ag-grid",
        "appNavigationLink": "a999112anlageNasslack",
        "subURL": "table",
        "category": "table",
        "globalCollection": "a999112anlageNasslack",
        "markup": [
          {
          ...
          {
            "description": "a999112anlageNasslack ag-grid dialog full screen",
            "type": "dialog",
                ...
                "children": [
                    ...
                    "children": [
                      {
                        ...
                        "tag": "div",
                        "text": "SORTING",
                        "class": "text-sm leading-6 font-medium uppercase text pl-2"
                      },
                      {
                        "description": "toggle button Gesamtanzahl WT icon change",
                        "type": "agGridEvent",
                        "eventType": "agGridSort",
                        "elementType": "toggleButton",
                        "key": "toggleItemIcon",
                        "parentClass": "w-20 h-8 mt-4 mb-8",
                        "children": [
                          {
                            "description": "stage1",
                            "value": {
                              state: [{ colId: 'Gesamtanzahl_WT', sort: 'asc' }],
                              defaultState: { sort: null },
                            },
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center rounded-lg cursor-pointer ",
                            "children": [
                              {
                                "type": "element",
                                "elementType": "staticHtmlTag",
                                "text": "Gesamtanzahl",
                                "class": "text text-gray-600 pl-2 mr-1 cursor-pointer"
                              },
                              {
                                "type": "element",
                                "elementType": "staticHtmlTag",
                                "text": "keyboard_double_arrow_up",
                                "class": "material-symbols-outlined text-lg text-gray-600 mr-1 cursor-pointer"
                              }
                            ]
                          },
                          {
                            "description": "stage2",
                            "value": {
                              state: [{ colId: 'Gesamtanzahl_WT', sort: 'desc' }],
                              defaultState: { sort: null },
                            },
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center cursor-pointer ",
                            "children": [
                              {
                                "type": "element",
                                "elementType": "staticHtmlTag",
                        ...
                        "children": [
                          {
                            ...
                            "listbox": {
                              "listboxButton": {
                                ...
                                "assignedKey": "material.treatment",
                                "children": [
                                  {
                                    "type": "container",
                                    "children": [
                  ...
                  },
                  {
                    ...
                    "children": [
                      ...
                      {
                        "description": "toggle button Warenträger icon change",
                        "type": "agGridEvent",
                        "eventType": "agGridFilter",
                        "elementType": "toggleButton",
                        "key": "toggleItemIcon",
                        "parentClass": "h-8 mt-4 mb-8",
                        "children": [
                          {
                            "description": "stage1",
                            "value": null,
                          ...
                          },
                          {
                            "description": "stage",
                            "value": [
                              { "cd": "INI, k, Gesamtanzahl_WT, equal, n, 1000" }
                            ],
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center rounded-lg cursor-pointer ",
                            "children": [
                          ...
                          },
                          {
                            "description": "stage",
                            "value": [
                              { "cd": "INI, k, Gesamtanzahl_WT, lt, n, 1000" }
                            ],
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center rounded-lg cursor-pointer ",
                            "children": [
                          ...
                          },
                          {
                            "description": "stage",
                            "value": [
                              { "cd": "INI, k, Gesamtanzahl_WT, gt, n, 1000" }
                            ],
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center rounded-lg cursor-pointer ",
                            "children": [
                          ...
                          },
                          {
                            "description": "stage",
                            "value": [
                              { "cd": "INI, k, Gesamtanzahl_WT, gte, n, 100" },
                              { "cd": "AND, k, Gesamtanzahl_WT, lte, n, 200" }
                            ],
                            "tag": "div",
                            "class": "w-full h-full flex justify-start items-center rounded-lg cursor-pointer ",
                            "children": [
              ...
              },
              {
                ...
                "query": [
                  {},
                  {
                    ...
                    "Startzeit": 1,
                    "Endzeit": 1,
                    "Produktionszeit_Dezimal": 1,
                    "Warenträger_pro_Stunde": 1,
                    "BC_Absoluter_Verbrauch_Lack": 1,
                    "BC_Absoluter_Verbrauch_Härter": 1,
                    "TC_Absoluter_Verbrauch_Lack": 1,
                    "TC_Absoluter_Verbrauch_Härter": 1,
                    "Gesamtunterbrechungsminuten": 1,
                    "U_Warten_auf_KTLBauteile": 1,
                    "Störung_Transport": 1,
                    "documentLock": 1
                  }
                ],
                ...
                "columnDefs": [
                  ...
                  {
                    "field": "Gesamtanzahl_WT",
                    "headerName": "Gesamanzahl WT",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "Produktionszeit_Dezimal",
                    "headerName": "Produktionszeit_Dezimal",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "Warenträger_pro_Stunde",
                    "headerName": "Warenträger_pro_Stunde",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "BC_Absoluter_Verbrauch_Lack",
                    "headerName": "BC_Absoluter_Verbrauch_Lack",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "BC_Absoluter_Verbrauch_Härter",
                    "headerName": "BC_Absoluter_Verbrauch_Härter",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "TC_Absoluter_Verbrauch_Lack",
                    "headerName": "TC_Absoluter_Verbrauch_Lack",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "TC_Absoluter_Verbrauch_Härter",
                    "headerName": "TC_Absoluter_Verbrauch_Härter",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "Gesamtunterbrechungsminuten",
                    "headerName": "Gesamtunterbrechungsminuten",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "U_Warten_auf_KTLBauteile",
                    "headerName": "U_Warten_auf_KTLBauteile",
                    "enableRowGroup": true,
                    "enablePivot": true
                  },
                  {
                    "field": "Störung_Transport",
                    "headerName": "Störung_Transport",
                    "enableRowGroup": true,
                    "enablePivot": true
                  }
                  ,
