...
export function useJsonLocal() {
  const jsonStructure = ref({
    ...
    "type": "appTemplate",
    "folderNavigationLink": "a666333jobOffers",
    "URL": "a666333jobOffers",
    "expressions": [
      {
    ...
    "appMarkup": [
      {
        "appNavigationLink": "a666333jobOffers",
        "globalCollection": "a666333jobOffers",
        "subURL": "home",
        "markup": [
          {
      ...
      {
        "appNavigationLink": "a666333candidates",
        "globalCollection": "a666333candidates",
        "subURL": "candidates",
        "markup": [
          {
            "description": "cddp Dialog",
                        ...
                        "children": [
                          {
                            ...
                            "children": [
                              ...
                              },
                              {
                                ...
                                "tag": "span",
                                "text": "expression:firstLastname",
                                "class": "text text-black font-bold"
                              }
                            ]
                          },
                          {
                          ...
                          },
                          {
                            "description": "card1 row 1",
                            "type": "container",
                            "class": "flex justify-start w-full mt-0 px-4",
                            "children": [
                              {
                                "description": "card4 row 2",
                                "type": "container",
                          ...
                          },
                          {
                            "description": "card1 row 1",
                            "type": "container",
                            "class": "flex justify-start w-full mt-2 px-4 pb-4",
                            "children": [
                              {
                                "description": "card4 row 2",
                                "type": "container",
                                ...
                                "children": [
                                  {
                                    ...
                                    "tag": "div",
                                    "assignedKey": "email",
                                    "class": "text text-black w-5/6 pl-3"
                                  }
                                ]
                              }
                            ]
                            ...
                            "children": [
                              {
                                ...
                                "tag": "div",
                                "text": "",
                                "assignedKey": "generalProjectTitle",
                                "class": "text-sm text-black w-5/6 pl-8"
                              }
                            ]
                          },
